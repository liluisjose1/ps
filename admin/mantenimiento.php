...
$sql = "SELECT sum(ROUND(((DATA_LENGTH + INDEX_LENGTH - DATA_FREE) / 1024 / 1024),2)) AS Size FROM INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA like '%ps%'";
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style=""> 
                                ...
                                <center>
                                            ...
                                            <h2>Vaciar tabla registro de Proyectos y Memorias</h2>
                                            <button class="btn btn-info btn-block example-the-2">Vaciar</button>
                                </center>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript"> 
    ...
    if (error=='no') {
        ...
        $('.example-the-2').on('click', function () {
            $.confirm({
                title: 'Advertencia!',
                content: 'Esta Seguro que desea vaciar los registros de proyectos?',
                type: 'red',
                typeAnimated: true,
                buttons: {
                    tryAgain: {
                        ...
                        btnClass: 'btn-red',
                        action: function(){
                            window.location = "logica/project_truncate.php";
                        }
                    },
                    close: function () {
                    }
